...
import static com.ymg.library.util.Constant.ADMOB;
import static com.ymg.library.util.Constant.AD_STATUS_ON;
import static com.ymg.library.util.Constant.APPLOVIN;
import static com.ymg.library.util.Constant.APPLOVIN_DISCOVERY;
import static com.ymg.library.util.Constant.APPLOVIN_MAX;
import static com.ymg.library.util.Constant.FAN;
import static com.ymg.library.util.Constant.FAN_BIDDING_ADMOB;
import static com.ymg.library.util.Constant.FAN_BIDDING_AD_MANAGER;
import static com.ymg.library.util.Constant.FAN_BIDDING_APPLOVIN_MAX;
import static com.ymg.library.util.Constant.FAN_BIDDING_IRONSOURCE;
import static com.ymg.library.util.Constant.GOOGLE_AD_MANAGER;
import static com.ymg.library.util.Constant.IRONSOURCE;
import static com.ymg.library.util.Constant.MOPUB;
import static com.ymg.library.util.Constant.NONE;
import static com.ymg.library.util.Constant.STARTAPP;
import static com.ymg.library.util.Constant.UNITY;
...
import com.ymg.library.util.AdManagerTemplateView;
import com.ymg.library.util.Constant;
import com.ymg.library.util.NativeTemplateStyle;
import com.ymg.library.util.TemplateView;
import com.ymg.library.util.Tools;
